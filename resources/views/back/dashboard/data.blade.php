                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                <span class="activity-icon bgl-secondary  mr-md-4 mr-3">
                                    <i class="fas fa-shirt" style="color: #A02CFA;font-size: 25px;"></i>
                                </span>
                                <div class="media-body">
                                    <p class="fs-14 mb-2">Pemesanan</p>
                                    <span class="title text-black font-w600">{{ $pemesanan }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                <span class="activity-icon bgl-danger mr-md-4 mr-3">
                                    <i class="fas fa-shirt" style="color: #FF3282;font-size: 25px;"></i>
                                </span>
                                <div class="media-body">
                                    <p class="fs-14 mb-2">Portpolio</p>
                                    <span class="title text-black font-w600">{{ $total_portpolio }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                <span class="activity-icon bgl-warning  mr-md-4 mr-3">
                                    <i class="fas fa-scroll" style="color: #FFBC11;font-size: 25px;"></i>
                                </span>
                                <div class="media-body">

                                    <p class="fs-14 mb-2">Kain</p>
                                    <span class="title text-black font-w600">{{ $total_kain }}</span>
                                </div>
                            </div>
                        </div>
